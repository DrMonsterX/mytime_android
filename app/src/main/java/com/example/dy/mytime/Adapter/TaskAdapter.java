...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(TaskAdapter.TaskViewHolder holder, final int position) {
        ...
        if (task.gettaskTag().equals("默认")) holder.la_taskbg.setBackgroundColor(Color.parseColor("#f185b3e4"));//修改了颜色
        else if (task.gettaskTag().equals("追星")) holder.la_taskbg.setBackgroundColor(Color.parseColor("#ed6997e1"));
