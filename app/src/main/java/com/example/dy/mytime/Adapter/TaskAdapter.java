...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(TaskAdapter.TaskViewHolder holder, final int position) {
        ...
        if (task.gettaskTag().equals("默认")) holder.la_taskbg.setBackgroundColor(Color.parseColor("#acdff9"));
        else if (task.gettaskTag().equals("追星")) holder.la_taskbg.setBackgroundColor(Color.parseColor("#8bd8f9"));
        else if (task.gettaskTag().equals("恋爱")) holder.la_taskbg.setBackgroundColor(Color.parseColor("#73c2f5"));
        else if (task.gettaskTag().equals("日常")) holder.la_taskbg.setBackgroundColor(Color.parseColor("#6dc1f7"));
        else if (task.gettaskTag().equals("工作")) holder.la_taskbg.setBackgroundColor(Color.parseColor("#58b7ef"));
